    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-black mb-4">For Mortgage Lenders</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Access 720+ FICO Borrowers Before They Shop Around
          </h2>
          <p className="text-gray-600 text-lg mb-10">
            Meatloaf users spend 12+ months building their credit in our platform. When they unlock pre-approval, you're already their trusted lender partner.
          </p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 mb-10">
            ...
            <ul className="space-y-4">
              {[
                'Pre-vetted credit history from 12-month journey',
                'First-time buyers eager to close',
                'Lower acquisition cost than traditional marketing',
                'Pipeline of qualified borrowers',
              ].map((benefit) => (
          ...
          <div className="border border-gray-200 rounded-2xl p-8 mb-10">
            ...
            <p className="text-4xl font-black text-gray-900 mb-1">$100<span className="text-xl font-normal text-gray-500">/month</span></p>
