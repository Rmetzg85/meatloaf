    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-gray-200">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white px-4 py-4 space-y-3">
            ...
            <Link href="/about" className="block text-gray-900 font-bold py-2" onClick={() => setMobileMenuOpen(false)}>About</Link>
            <Link href="/auth/login" className="block text-gray-700 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>Login</Link>
            <Link href="/mimosa" className="block text-pink-500 font-medium py-2" onClick={() => setMobileMenuOpen(false)}>Switch to Mimosa →</Link>
            <Link href="/auth/signup" className="block w-full text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold" onClick={() => setMobileMenuOpen(false)}>Get Started</Link>
          </div>
        )}
      </nav>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 md:mb-16">
            ...
            {/* Pull quote */}
            <blockquote className="my-8 md:my-10 border-l-4 border-blue-600 pl-6">
            ...
            {/* Stat callout */}
            <div className="my-8 md:my-10 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 md:p-8 text-center">
              <p className="text-4xl md:text-5xl font-black bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-3">72 million</p>
          ...
          <div className="mb-12 md:mb-16">
            ...
            <div className="space-y-6 text-gray-700 text-base md:text-lg leading-relaxed">
              <p className="text-xl md:text-2xl font-bold text-gray-900">That's why I built Meatloaf.</p>
              <p>
          ...
          <div className="mb-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 md:p-8 space-y-3 text-gray-700 text-base md:text-lg leading-relaxed">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/auth/signup"
            className="inline-block bg-white text-blue-600 px-8 md:px-10 py-4 rounded-lg font-bold text-lg hover:shadow-2xl transition transform hover:-translate-y-1"
          >
            Get Started Free
          </Link>
