    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-pink-900 to-rose-800">
        <div className="py-32 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl text-pink-100 leading-relaxed max-w-2xl">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            {/* Pull quote */}
            <blockquote className="my-10 border-l-4 border-pink-500 pl-6">
            ...
            {/* Stat callout */}
            <div className="my-10 bg-gradient-to-r from-pink-50 to-rose-50 rounded-2xl p-8 text-center">
              <p className="text-5xl font-black bg-gradient-to-r from-pink-500 to-rose-400 bg-clip-text text-transparent mb-3">72 million</p>
          ...
          <div className="mb-16">
            ...
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p className="text-2xl font-bold text-gray-900">That's why I built Mimosa.</p>
              <p>
          ...
          <div className="mb-4">
            ...
            <div className="bg-gradient-to-r from-pink-50 to-rose-50 rounded-2xl p-8 space-y-3 text-gray-700 text-lg leading-relaxed">
