    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-black mb-4">For Real Estate Agents</h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Exclusive Pipeline of Mortgage-Ready First-Time Homebuyers
          </h2>
          <p className="text-gray-600 text-lg mb-10">
            Every user on Meatloaf is working toward homeownership. When they hit 720+ FICO, they're ready to tour — and you're first in line.
          </p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 mb-10">
            ...
            <ul className="space-y-4">
              {[
                'Users hitting 720+ FICO ready to tour properties',
                'Pre-approved buyers eager to close',
                'Lower competition than Zillow leads',
                'Exclusive access before they shop around',
              ].map((benefit) => (
